...
// body...
    ...
    $.extend(Video.prototype, {
        ...
        _renderVideo: function(src) {
            ...
            var video = $(('<div class="yvp_video"><video id="video" preload="none" x-webkit-airplay="true" src="${videosrc}" ' + (virtualFullScreen? 'webkit-playsinline':'') + '></video></div>').replace(/\${.*\}/i, src));

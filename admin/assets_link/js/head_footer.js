...
header += '<a href="index.html" class="index_page">首页</a><a href="digital_asset.html" class="ico_public">数字资产</a><a href="assets_link.html" class="asset_link">资产链</a><a href="/forum/index.html" target="_blank" class="block_datas">社区</a><a href="newspaper.html" class="news">资讯</a><a href="https://market.acchain.org" class="market_page"  target="_blank">集市</a><a href="account_view.html" class="mine">我的</a>';
header += '</div>';
header += '</div>';                                        
                    
var language_choose = ' <div class="language_choose"><div class="language_box"><p class="language_text"><img src="img/flag_china.png" alt=""/></p><em class="down_icon"></em><ul id="language_gather" style="display: none;"><li class="language_option"><a href="'+ href +'"><img src="img/flag_usa.png" alt="" /></a></li></ul></div></div>';
...
footer += '<p class="clearfix"><img src="img/bot_logo.png" alt="" class="fl"><span class="fl">Copyright © 2017-2019 ｜ACChain<a href="http://www.miitbeian.gov.cn/publish/query/indexFirst.action" target="_blank">.黔ICP备17004079号-1</a>.all rights reserved.</span></p>';
footer += '</div>';

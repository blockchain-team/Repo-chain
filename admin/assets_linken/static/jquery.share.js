...
;(function($){
    ...
    $.fn.share = function ($options) {
        ...
        var $defaults = {
            ...
            wechatQrcodeTitle: 'Scan QR Code to Share',
            wechatQrcodeHelper: '<p>Click “Discover”, and choose "Scan QR Code"to share this article on moments</p>',
        ...
        function createWechat ($container, $data) {
            ...
            $wechat.append('<div class="wechat-qrcode"><h4>'+$data.wechatQrcodeTitle+'</h4><div class="qrcode"><img src="img/share_wx.png" alt="" /></div><div class="help">'+$data.wechatQrcodeHelper+'</div></div>');
